...
#define game_mode 0x100DCDA8// its right
namespace player_info
{
	constexpr auto local_index = 0xB1D00;//ok
	//    constexpr auto local_index = 0xF3F50;
//    constexpr auto local_index_pos = 0x2D0;
	constexpr auto local_index_pos = 0x2D0;//ok;
	constexpr auto size = 0x6980;//ok
	constexpr auto valid = 0x1301;//ok
	constexpr auto team_id = 0xFF8;//ok
	constexpr auto position_ptr = 0xF70;//ok
	constexpr auto stance = 0xEE4;//ok
	constexpr auto dead_1 = 0x1E0A;//ok
	constexpr auto dead_2 = 0x1FD0;//ok
	constexpr auto weapon_index = 0x1394;//ok
}

namespace bones
{
	constexpr auto bone_base_pos = 0xEBB30;//ok
	constexpr auto size = 0x180;//ok
	constexpr auto visible = 0x28047A0;//ok
	constexpr auto weapon_definitions = 0x13830F90;//ok
	constexpr auto distribute = 0xBAA6998;//ok
}

namespace view_port
{
	constexpr auto refdef_ptr = 0x138ADB38;//ok
	constexpr auto camera_ptr = 0x13ECD810;//ok
...
namespace client
{//ok
	constexpr auto name_array = 0x138CCF20;
	constexpr auto name_array_padding = 0x5E70;//ok   
	//    constexpr auto name_array = 0x13072A30;
//    constexpr auto name_array_padding = 0x5E70;
	constexpr auto name_array_size = 0xD0;//ok
}
//#define game_mode 0xF8831D8// its right
//namespace player_info
//{
//	constexpr auto local_index = 0xF3F50;
//	constexpr auto local_index_pos = 0x2D0;
...
//	constexpr auto visible = 0x22E2700; // RIGHT OFFSETS: 0x22E2700
//
//	constexpr auto distribute = 0xB30F838;
//}
//
//namespace view_port
//{
//	constexpr auto refdef_ptr = 0x130534B0;
//	constexpr auto camera_ptr = 0x13672EC0;

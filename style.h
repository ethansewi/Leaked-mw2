...
public:
	...
	static void ApplyTheme2()
	{
		...
		colors[ImGuiCol_Button] = ImVec4(0.541f, 0.169f, 0.886f, 1.00f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.541f, 0.169f, 0.886f, 1.00f);
		...
		colors[ImGuiCol_Tab] =  ImVec4(0.541f, 0.169f, 0.886f, 1.00f);
		colors[ImGuiCol_TabHovered] =  ImVec4(0.541f, 0.169f, 0.886f, 1.00f);
		colors[ImGuiCol_TabHovered] =  ImVec4(0.541f, 0.169f, 0.886f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(0.541f, 0.169f, 0.886f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(0.541f, 0.169f, 0.886f, 1.00f);

...
namespace g_game
{
	...
	bool w2s(Vector3 world_location, Vector2& out, Vector3 camera_pos, int screen_width, int screen_height, Vector2 fov, Vector3 matricies[3], Vector2* BoxSize)
	{
		auto local = world_location - camera_pos;
		auto trans = Vector3{
			local.Dot(matricies[1]),
